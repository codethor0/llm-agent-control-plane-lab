...
- mypy: pass
- pytest: 293 passed (host; run `python -m pytest` to confirm on release commit)
...
- docker compose run --rm app python -m pytest: 293 passed (Docker image copy of tests)
