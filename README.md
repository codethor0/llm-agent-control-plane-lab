...
[![Tests](https://img.shields.io/badge/tests-111%20passing-brightgreen)](https://github.com/codethor0/llm-agent-control-plane-lab/actions)
...
- Maps [security invariants](docs/defensive-controls.md) to **111** automated tests
...
| Check | Command | Notes |
|-------|---------|-------|
| All checks | `make validate` | lint, types, 111 tests, repo hygiene, policy integrity, bandit, pip-audit, Docker |
| Tests | `python -m pytest` | 111 security-focused tests |
