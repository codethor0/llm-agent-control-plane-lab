...
[![Tests](https://img.shields.io/badge/tests-128%20passing-brightgreen)](https://github.com/codethor0/llm-agent-control-plane-lab/actions)
...
- Maps [security invariants](docs/defensive-controls.md) to **128** automated tests
...
| Check | Command | Notes |
|-------|---------|-------|
| All checks | `make validate` | lint, types, 128 tests, repo hygiene, policy integrity, bandit, pip-audit, Docker |
| Tests | `python -m pytest` | 128 security-focused tests |
