...
[![Tests](https://img.shields.io/badge/tests-98%20passing-brightgreen)](https://github.com/codethor0/llm-agent-control-plane-lab/actions)
...
- Maps [security invariants](docs/defensive-controls.md) to **98** automated tests
...
| Check | Command | Notes |
|-------|---------|-------|
| All checks | `make validate` | lint, types, 98 tests, repo hygiene, policy integrity, bandit, pip-audit, Docker |
| Tests | `python -m pytest` | 98 security-focused tests |
